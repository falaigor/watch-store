...
describe("Cart Store", () => {
  ...
  it("should assing 1 as initial quantity on product add()", () => {
  ...
  it("should not change products in the cart if provider product is note in the array", () => {
